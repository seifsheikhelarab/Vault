    ...
    <div className="min-h-screen bg-warm-white flex">
      ...
      <div className="flex-1 flex items-center justify-center px-6 lg:px-16">
        <div className="w-full max-w-[340px]">
          ...
          <h1 className="text-2xl font-bold text-text-primary tracking-tight mb-1.5">Create your account</h1>
          <p className="text-sm text-text-secondary mb-10">Free forever. No credit card needed.</p>
          ...
          <p className="text-center text-sm text-text-secondary mt-8">
            ...
            <Link to="/sign-in" className="text-coral font-semibold hover:text-coral-dark transition-colors">
              Sign in
            </Link>
          </p>
        </div>
      ...
      <div className="hidden lg:flex flex-1 bg-cream/60 items-center justify-center relative overflow-hidden">
        ...
        <div className="relative text-center max-w-[280px]">
          ...
          <p className="text-sm text-text-secondary leading-relaxed">
            Smart categories, interactive charts, and budgets that actually work. Your money, visualized.
          </p>
        </div>
      </div>
    </div>
