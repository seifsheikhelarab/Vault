            ...
            <section className="relative py-24 lg:py-36 overflow-hidden">
                ...
                >
                    ...
                    <p className="text-lg text-text-secondary max-w-lg mb-10 leading-relaxed">
                        Log expenses in seconds. See where your money goes.
                    ...
                    <div className="flex items-center gap-3">
                        <Link
                            to="/sign-up"
                            data-cuelume-press
                            className="px-6 py-3 bg-coral text-white text-sm font-semibold rounded-[10px] hover:bg-coral-dark active:scale-[0.98] transition-colors transition-transform duration-150"
                        >
                            Get started free
                        </Link>
                        <Link
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-12 gap-x-16">
                        <div>
                            ...
                            <p className="text-text-primary text-base leading-relaxed">
                                Categorize every purchase, set monthly budgets,
                                and watch your spending with real charts. Not a
                                spreadsheet, not a spreadsheet wrapper.
                            </p>
                        </div>
                        <div>
                            <h3 className="text-sm font-semibold text-coral uppercase tracking-wider mb-3">
                            ...
                            <p className="text-text-primary text-base leading-relaxed">
                                Create a group, add people, split any expense.
                                See who owes what at a glance. Settle up when
                                you're ready.
                            </p>
                        </div>
                        <div>
                            ...
                            <p className="text-text-primary text-base leading-relaxed">
                                Department budgets, expense submissions,
                                approval workflows. For teams that need
                        ...
                        <div>
                            ...
                            <p className="text-text-primary text-base leading-relaxed">
                                Not a weekend hack. Real auth, real database,
                                real deployments. The kind of stack you'd trust
                                with your own money.
                            </p>
                        </div>
                    </div>
            ...
            <section className="py-20 lg:py-28 border-t border-border-light">
                <div className="max-w-[800px] mx-auto px-6 text-center">
                    ...
                    <p className="text-text-secondary mb-8 max-w-md mx-auto">
                        Free forever for personal use. No credit card, no trial,
                        no gimmicks.
                    </p>
                    <Link
                        to="/sign-up"
            ...
            <footer className="border-t border-border-light py-8">
                <div className="max-w-[800px] mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <p className="text-xs text-text-tertiary">
                        React, TanStack, Hono, Drizzle, PostgreSQL
                    </p>
                </div>
            </footer>
        </div>
