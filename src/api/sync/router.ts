...
router.post('/push', validateJson(pushBatchSchema), (c) => pushController(c, c.req.valid('json')));
router.get('/pull', validateQuery(pullQuerySchema), (c) => pullController(c, c.req.valid('query')));
