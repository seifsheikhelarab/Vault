...
import { user, session, account, invitation, member, organization, verification } from "./auth-schema";
...
export { sessionRelations, accountRelations, organizationRelations, memberRelations, invitationRelations } from "./auth-schema";
...
export const splitsRelations = relations(splits, ({ one }) => ({
  expense: one(expenses, { fields: [splits.expenseId], references: [expenses.id] }),
...
export const settlementsRelations = relations(settlements, ({ one }) => ({
  fromUser: one(user, { fields: [settlements.fromUserId], references: [user.id] }),
  toUser: one(user, { fields: [settlements.toUserId], references: [user.id] }),
...
export const claimsRelations = relations(claims, ({ one }) => ({
  expense: one(expenses, { fields: [claims.expenseId], references: [expenses.id] }),
